...
botany-swab-used = This swab has been used to collect from {$toBeForm}[color=green]{$seedName}[/color].
botany-swab-unused = This swab is clean and ready to be used.
